  ...
  return (
    <LandingPageContainer>
      <section id="textsContainer">
        ...
        <div className="about">
          <span>
            Lori ipsum dolor sit amet consectetur adipisicing elit. Possimus,
            voluptate eius deserunt velit nam consequatur repellat delectus
            magni, quia sit cumque similique consequuntur? Illum ab debitis,
            excepturi iusto fugiat minima?
          </span>
        </div>
